...
public static class QueryHelper
{
    ...
    public static IQueryable<TEntity> WhereIf<TEntity>(this IQueryable<TEntity> queryable, bool criteria,
    ...
    public static Task<long> CountIfAsync<TEntity>(this IQueryable<TEntity> queryable,
    ...
    public static async Task<IEnumerable<T>> GetFromQueryAsync<T>(this DbContext dbContext, string sqlString,
