...
builder.Services.AddEventSourcing<Domain.Order>(appSettings.ConnectionStrings.Database);

builder.Services.AddQueryRepository<Domain.Order, OrderReadDbContext>();
